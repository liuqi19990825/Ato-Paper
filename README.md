...
一款为 Typecho 1.3.0 制作的纸张风个人博客主题，由 Ato 与 Codex 共同构建。当前版本为 0.8.1。
...
- 响应式手机布局、键盘焦点与减少动效支持
- 手机菜单为长子页面标题提供更宽的纸片面板，并让层级导轨、圆点与首行文字准确对齐
- 提供 Web App Manifest、安装图标、独立显示模式及移动设备安全区域适配，纸张底色会延伸至支持的 Android 手势导航区
- 文章副标题、题图和题图说明自定义字段
