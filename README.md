...
一款为 Typecho 1.3.0 制作的纸张风个人博客主题，由 Ato 与 Codex 共同构建。当前版本为 0.10.0。
...
该功能默认关闭，转载协议可通过“复制出处协议”修改。它同时写入剪贴板的纯文本与富文本格式，但不会处理评论、导航和其他界面文字，也不会影响代码块的选中复制或一键复制。功能交互灵感来自 Sakura，剪贴板逻辑为 Ato Paper 独立实现。
