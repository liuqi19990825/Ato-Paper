...
Except for the components identified below, Ato Paper's original code and original assets are licensed under the MIT License in `LICENSE`.

The MIT License does not replace or relicense third-party material. Each third-party component remains under its own license. In particular, `inc/emotes.php`, `assets/emotes/tieba/`, and `assets/emotes/bilibili/` contain or adapt Sakura-compatible material and are distributed under GNU GPL version 2 or later. Redistributors of the complete theme must preserve this notice and the corresponding license copies.
...
Sakura-compatible data and Typecho integration covered by GPL v2 or later:
